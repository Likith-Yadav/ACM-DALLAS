...
import hackutdIcon from '../assets/about/hackutd.svg';
            ...
            >
              ...
              <div className="mt-4 text-center">
                <h3 className="text-lg sm:text-xl font-bold mb-1">
                  ...
                  <span className={`${division.gradient} bg-clip-text text-transparent`}>
                    {division.name === 'hackutd' ? 'HackUTD' : 
                     division.name === 'industry' ? 'Industry' : division.title}
                  </span>
                </h3>
              </div>
              ...
              <div className="mt-4 flex-grow">
                <div className="m-5 flex flex-col items-center gap-2">
                  <div className={`flex items-center rounded-lg ${division.gradient} p-[1px]`}>
                    {division.href ? (
                      <a 
