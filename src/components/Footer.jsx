    ...
    <footer className="bg-black/90 border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* ACM at UTD Section */}
          <div className="flex flex-col items-start">
            <h3 className="text-white font-bold text-lg mb-4">ACM Dallas</h3>
          ...
          <div className="flex flex-col items-start">
            ...
            <a
              href="mailto:contact@acmdallas.co"
              className="text-white/80 hover:text-white transition-colors"
            >
              contact@acmdallas.co
            </a>
          </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="grid grid-cols-3 gap-4">
              {/* Top Row */}
              <a
                href="https://linkedin.com/company/acmdallas"
                target="_blank"
              ...
              <a
                href="https://instagram.com/acmdallas"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-all duration-300"
              >
              ...
              <a
                href="https://discord.gg/acmdallas"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-all duration-300"
              >
              ...
              {/* Bottom Row */}
              <a
                href="https://github.com/acmdallas"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-all duration-300"
              >
              ...
              <a
                href="https://youtube.com/@acmdallas"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-all duration-300"
              >
